<?php 
	...
	$query = "SELECT * FROM `phyquestions` WHERE `question_number` = $number";
	...
	//Get Choices
	$query = "SELECT * FROM phyoptions WHERE question_number = $number";
...
<link href="https://fonts.googleapis.com/css2?family=Playball&display=swap" rel="stylesheet">
  ...
  <nav style="background-color:black;">
	...
	<div class="container my-4 text-white p-4 col-md-8" style="background-color: black;">
				...
				<form method="POST" action="phyprocess.php">
					<ul class="choicess">
					...
					<input type="submit" name="submit" value ="submit" class="btnc btn-primary mb-3">
