    ...
    <div class="alert alert-success" role="alert">
      ...
      <hr>
			...
			<div class="container p-4 my-4" style="background-color: aqua;">
				<h2>Your Result</h2>
				<p>Congratulation You have completed the Chemistry test succesfully.</p>
				<p>Your <strong>Score</strong> is <?php echo $_SESSION['cscore']; ?>  </p>
	  ...
	  $chemmarks = $_SESSION['cscore'];
	  $sql = "INSERT INTO `cmarks` (`email`,`cscore`) values ('$email','$chemmarks')"; 
