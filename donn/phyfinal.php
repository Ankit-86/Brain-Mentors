...
<link href="https://fonts.googleapis.com/css2?family=Playball&display=swap" rel="stylesheet">
  ...
  <nav >
            ...
            <div class="menu" >
                <a href="books.php" class="buttonc" >Home</a>
    ...
    <div class="alert alert-success" role="alert">
      ...
      <hr>
			...
			<div class="container p-4 my-4" style="background-color: aqua;">
				<h2>Your Result</h2>
				<p>Congratulations <?php echo $_SESSION['email']?>. You have completed the Physics test succesfully.</p>
				<p>Your <strong>Score</strong> is <?php echo $_SESSION['pscore']; ?>  </p>
				<?php //unset($_SESSION['cscore']); ?>
				<p class="mb-0">Whenever you need to, be sure to <a href="logout.php" style="color:blue">Logout</a></p>
			</div>
			<?php 	 
			include 'db.php';
	  $email = $_SESSION['email'];
	  $phymarks = $_SESSION['pscore'];
	  $sql = "INSERT INTO `pmarks` (`email`,`pscore`) values ('$email','$phymarks')"; 
