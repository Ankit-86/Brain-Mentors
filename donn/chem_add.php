...
if(isset($_POST['submit'])){
 ...
 // First Query for Questions Table
	...
	$query = "INSERT INTO chemquestions (";
...
<nav>
	...
	<main>
			<div class="container my-4 text-white p-4 col-md-6" style="background-color: black;">
				<h2>Add Chemistry Questions</h2>
				<?php if(isset($message)){
					echo "<h4>" . $message . "</h4>";
				} ?>
								
				<form method="POST" action="chem_add.php">
		...
		<br>
		<center>
		<input type="submit" name="submit" value ="submit" class="btn btn-primary mb-3"></center>
				</form>
			</div>
	</main>
</body>
